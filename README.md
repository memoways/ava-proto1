...
> **Mise à jour récente (2026-07-13) — Phase 2 : fluidité et endurance 15 minutes** : durée portée à 15 minutes, contexte LLM borné, résumé persistant, RAG fail-soft, annulation des tours obsolètes et watchdog de récupération. Les tests couvrent 1 050 tours orchestrateur et un soak navigateur de 35 tours avec pannes injectées. Il reste à publier sur Lovable, redéployer `summarize-session` et effectuer la recette réelle de 15 minutes. Détails : [`docs/phase2_fluidity_endurance_report.md`](docs/phase2_fluidity_endurance_report.md).
